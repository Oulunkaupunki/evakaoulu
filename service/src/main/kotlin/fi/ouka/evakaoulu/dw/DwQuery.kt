...
enum class DwQuery(
    ...
    DAILY_OCCUPANCY_REALIZED("daily_units_occupancy_realized_", DwQueries.getDailyUnitsOccupanciesRealized),
...
enum class FabricQuery(
    ...
    DAILY_OCCUPANCY_CONFIRMED("daily_units_occupancy_confirmed_", FabricQueries.getDailyUnitsOccupanciesConfirmed),
    DAILY_OCCUPANCY_REALIZED("daily_units_occupancy_realized_", FabricQueries.getDailyUnitsOccupanciesRealized),
    ...
    OTHER_ASSISTANCE_MEASURE("other_assistance_measures_", FabricQueries.getOtherAssistanceMeasures()),
...
enum class FabricHistoryQuery(
    ...
    OTHER_ASSISTANCE_MEASURE("other_assistance_measures_", FabricQueries.getOtherAssistanceMeasures(true)),
