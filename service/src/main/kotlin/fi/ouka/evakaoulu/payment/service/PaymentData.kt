...
val paymentRowFields = listOf(
    ...
    PaymentField(PaymentFieldName.INVOICE_ACCEPTANCE, FieldType.NUMERIC, 23, 1),
    PaymentField(PaymentFieldName.VOUCHER_TYPE, FieldType.NUMERIC, 24, 2),
    PaymentField(PaymentFieldName.VOUCHER_NUMBER, FieldType.ALPHANUMERIC, 26, 8), //TODO check if needed new type, because of row-data
    PaymentField(PaymentFieldName.VOUCHER_DATE, FieldType.ALPHANUMERIC, 34, 6),
    PaymentField(PaymentFieldName.INVOICE_TYPE, FieldType.NUMERIC, 40, 1),
    PaymentField(PaymentFieldName.BREAKDOWN_TYPE, FieldType.NUMERIC, 41, 1),
    ...
    PaymentField(PaymentFieldName.INVOICE_SUM, FieldType.ALPHANUMERIC, 136, 12),
