...
package fi.oulu.evakaoulu.emailclient.config
...
internal class EmailMessageProvider(): IEmailMessageProvider {
    ...
    override fun getClubApplicationReceivedEmailHtml(): String {
        return """
            ...
            <p>Hakemuksen tehnyt huoltaja voi muokata hakemusta Oulun varhaiskasvatuksen verkkopalvelussa osoitteessa <a href="https://varhaiskasvatus.tampere.fi">varhaiskasvatus.tampere.fi</a> siihen saakka, kunnes se on otettu käsittelyyn asiakaspalvelussa.</p>
