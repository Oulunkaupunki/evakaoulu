...
VALUES
    ...
    ('DEVELOPMENTAL_DISABILITY_1', 'Muu kuin vaikeimmin kehitysvammainen', 'Merkitään hallintopäätöksen jälkeen. (Tieto menee KOSKI-palveluun)', 310),
    ('DIFFERENT_EDUCTATION_START_DATE', 'Opetuksen poikkeava aloittamisajankohta', 'Merkitään päätöksen jälkeen.', 320),
    ('DEVELOPMENTAL_DISABILITY_2', 'Vaikeimmin kehitysvammainen', 'Lapsella on todettu kehitysvamma, tieto tarvitaan tilastointia varten. (Tieto menee KOSKI-palveluun)', 330),
