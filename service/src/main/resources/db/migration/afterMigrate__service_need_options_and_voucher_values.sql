...
INSERT INTO service_need_option
    (id, name_fi, name_sv, name_en, contract_days_per_month, valid_placement_type, default_option, fee_coefficient, occupancy_coefficient, daycare_hours_per_week, part_day, part_week, fee_description_fi, fee_description_sv, voucher_value_description_fi, voucher_value_description_sv, display_order, occupancy_coefficient_under_3y, show_for_citizen, realized_occupancy_coefficient, realized_occupancy_coefficient_under_3y)
VALUES
    -- DAYCARE
    ('de463972-9f97-11ec-a22c-931f5a294cea','Kokoaikainen varhaiskasvatus','Kokoaikainen varhaiskasvatus','Full-time early childhood education',NULL,'DAYCARE',TRUE,1.0,1.0,40,FALSE,FALSE,'Kokoaikainen varhaiskasvatus','Kokoaikainen varhaiskasvatus','Kokoaikainen varhaiskasvatus','Kokoaikainen varhaiskasvatus', null, 1.75, true, 1.0, 1.75),
    ('86ef70a0-bf85-11eb-91e6-1fb57a101161','Kokoaikainen varhaiskasvatus','Kokoaikainen varhaiskasvatus','Full-time early childhood education',NULL,'DAYCARE',FALSE,1.0,1.0,40,FALSE,FALSE,'Kokoaikainen varhaiskasvatus','Kokoaikainen varhaiskasvatus','Kokoaikainen varhaiskasvatus','Kokoaikainen varhaiskasvatus', 1, 1.75, true, 1.0, 1.75),
    ('503590f0-b961-11eb-b520-53740af3f7ee','Kokoaikainen varhaiskasvatus 10 pv/kk','Kokoaikainen varhaiskasvatus 10 pv/kk','Full-time early childhood education 10 d/M',10,'DAYCARE',FALSE,0.5,0.54,20.2,FALSE,FALSE,'Kokoaikainen varhaiskasvatus 10 pv/kk','Kokoaikainen varhaiskasvatus 10 pv/kk','Kokoaikainen varhaiskasvatus 10 pv/kk','Kokoaikainen varhaiskasvatus 10 pv/kk', 2, 1.75, true, 0.54, 1.75),
    ('503591ae-b961-11eb-b521-1fca99358eef','Kokoaikainen varhaiskasvatus 13 pv/kk','Kokoaikainen varhaiskasvatus 13 pv/kk','Full-time early childhood education 13 d/M',13,'DAYCARE',FALSE,0.75,0.77,26.3,FALSE,FALSE,'Kokoaikainen varhaiskasvatus 13 pv/kk','Kokoaikainen varhaiskasvatus 13 pv/kk','Kokoaikainen varhaiskasvatus 13 pv/kk','Kokoaikainen varhaiskasvatus 13 pv/kk', 3, 1.75, true, 0.77, 1.75),
    ('c2886f84-9ef2-11ec-8538-734ab2ac6c71','Varhaiskasvatus alle 7-h päivä','Varhaiskasvatus alle 7-h päivä','Early childhood education under 7-h day',NULL,'DAYCARE',FALSE,0.75,1.0,35,FALSE,FALSE,'Varhaiskasvatus alle 7-h päivä','Varhaiskasvatus alle 7-h päivä','Varhaiskasvatus alle 7-h päivä','Varhaiskasvatus alle 7-h päivä', 1003,1.75, true, 1.0, 1.75),
    ('c288a058-9ef2-11ec-853e-9bcaa26ea729','Yksityinen varhaiskasvatus','Yksityinen varhaiskasvatus','Private early childhood education',NULL,'DAYCARE',FALSE,1.0,1.0,40,FALSE,FALSE,'Yksityinen varhaiskasvatus','Yksityinen varhaiskasvatus','Yksityinen varhaiskasvatus','Yksityinen varhaiskasvatus', 4, 1.75, true, 1.0, 1.75),
    ('c288a0c6-9ef2-11ec-853f-47b02ebd51bb','Yksityinen varhaiskasvatus palse','Yksityinen varhaiskasvatus palse','Private early childhood education service voucher',NULL,'DAYCARE',FALSE,1.0,1.0,40,FALSE,FALSE,'Yksityinen varhaiskasvatus palse','Yksityinen varhaiskasvatus palse','Yksityinen varhaiskasvatus palse','Yksityinen varhaiskasvatus palse', 5,1.75, false, 1.0, 1.75),
    ('19094188-130d-11ed-a572-473907d23b65','Yksityinen perhepäivähoito palse','Yksityinen perhepäivähoito palse','Private family daycare service voucher',NULL,'DAYCARE',FALSE,1.0,1.0,40,FALSE,FALSE,'Yksityinen perhepäivähoito palse','Yksityinen perhepäivähoito palse','Yksityinen perhepäivähoito palse','Yksityinen perhepäivähoito palse', 6,1, false, 1.0, 1.75),

    -- DAYCARE_PART_TIME
    ('de463bd4-9f97-11ec-a22d-4791bc036bd9','Varhaiskasvatus alle 5-h päivä','Varhaiskasvatus alle 5-h päivä','Early childhood education under 5-h day',NULL,'DAYCARE_PART_TIME',TRUE,0.6,0.54,25,FALSE,FALSE,'Varhaiskasvatus alle 5-h päivä','Varhaiskasvatus alle 5-h päivä','Varhaiskasvatus alle 5-h päivä','Varhaiskasvatus alle 5-h päivä', null,1.75, true, 0.54, 1.75),
    ('86ef7370-bf85-11eb-91e7-6fcd728c518d','Varhaiskasvatus alle 5-h päivä','Varhaiskasvatus alle 5-h päivä','Early childhood education under 5-h day',NULL,'DAYCARE_PART_TIME',FALSE,0.6,0.54,25,FALSE,FALSE,'Varhaiskasvatus alle 5-h päivä','Varhaiskasvatus alle 5-h päivä','Varhaiskasvatus alle 5-h päivä','Varhaiskasvatus alle 5-h päivä', 1000,1.75, true, 0.54, 1.75),
    ('c2886fca-9ef2-11ec-8539-1b9652921b6d','Yksityinen osa-aikainen 12-13pv/kk palse','Yksityinen osa-aikainen 12-13pv/kk palse','Private part time 12-13d/m service voucher',NULL,'DAYCARE_PART_TIME',FALSE,0.65,1.0,26.3,FALSE,FALSE,'Yksityinen osa-aikainen 12-13pv/kk palse','Yksityinen osa-aikainen 12-13pv/kk palse','Yksityinen osa-aikainen 12-13pv/kk palse','Yksityinen osa-aikainen 12-13pv/kk palse', null,1.75, false, 1.0, 1.75),
    ('c2889e1e-9ef2-11ec-853a-aff6768857cb','Yksityinen osa-aikainen 29h/viikko palse','Yksityinen osa-aikainen 29h/viikko palse','Private part time 29h/week service voucher',NULL,'DAYCARE_PART_TIME',FALSE,0.6,1.0,29,FALSE,FALSE,'Yksityinen osa-aikainen 29h/viikko palse','Yksityinen osa-aikainen 29h/viikko palse','Yksityinen osa-aikainen 29h/viikko palse','Yksityinen osa-aikainen 29h/viikko palse', null,1.75, false, 1.0, 1.75),
    ('c2889ef0-9ef2-11ec-853b-2f545a699ef0','Yksityinen osapäivä','Yksityinen osapäivä','Private part time',NULL,'DAYCARE_PART_TIME',FALSE,0.5,0.54,20,TRUE,FALSE,'Yksityinen osapäivä','Yksityinen osapäivä','Yksityinen osapäivä','Yksityinen osapäivä', null,1.75, true, 0.54, 1.75),
    ('c2889f72-9ef2-11ec-853c-3bc6a35d44a3','Yksityinen osapäivä 4h palse','Yksityinen osapäivä 4h palse','Private part time 4h service voucher',NULL,'DAYCARE_PART_TIME',FALSE,0.5,0.54,20,TRUE,FALSE,'Yksityinen osapäivä 4h palse','Yksityinen osapäivä 4h palse','Yksityinen osapäivä 4h palse','Yksityinen osapäivä 4h palse', null,1.75, false, 0.54, 1.75),
    ('50359334-b961-11eb-b525-f3febdfea5d3','Yksityinen osaviikko 20h palse','Yksityinen osaviikko 20h palse','Private part time 20h service voucher',NULL,'DAYCARE_PART_TIME',FALSE,0.5,0.54,20,FALSE,TRUE,'Yksityinen osaviikko 20h palse','Yksityinen osaviikko 20h palse','Yksityinen osaviikko 20h palse','Yksityinen osaviikko 20h palse', null,1.75, false, 0.54, 1.75),
    ('86495b70-130d-11ed-a573-bfda992853b8','Yksityinen perhepäivähoito osaviikko 20h palse','Yksityinen perhepäivähoito osaviikko 20h palse','Private family daycare part time 20h service voucher',NULL,'DAYCARE_PART_TIME',FALSE,0.55,0.54,20,FALSE,TRUE,'Yksityinen perhepäivähoito osaviikko 20h palse','Yksityinen perhepäivähoito osaviikko 20h palse','Yksityinen perhepäivähoito osaviikko 20h palse','Yksityinen perhepäivähoito osaviikko 20h palse', null,1, false, 0.54, 1.0),
    ('d146f678-130d-11ed-a574-c39e98171347','Yksityinen perhepäivähoito osa-aikainen 12-13pv/kk palse','Yksityinen perhepäivähoito osa-aikainen 12-13pv/kk palse','Private family daycare part time 12-13d/m service voucher',NULL,'DAYCARE_PART_TIME',FALSE,0.65,1.0,26.3,FALSE,FALSE,'Yksityinen perhepäivähoito osa-aikainen 12-13pv/kk palse','Yksityinen perhepäivähoito osa-aikainen 12-13pv/kk palse','Yksityinen perhepäivähoito osa-aikainen 12-13pv/kk palse','Yksityinen perhepäivähoito osa-aikainen 12-13pv/kk palse', null,1, false, 1.0, 1.0),
    ('07a1bde8-130e-11ed-a575-bbe09459e8d0','Yksityinen perhepäivähoito osa-aikainen 29h/viikko palse','Yksityinen perhepäivähoito osa-aikainen 29h/viikko palse','Private family daycare part time 29h/week service voucher',NULL,'DAYCARE_PART_TIME',FALSE,0.6,1.0,29,FALSE,FALSE,'Yksityinen perhepäivähoito osa-aikainen 29h/viikko palse','Yksityinen perhepäivähoito osa-aikainen 29h/viikko palse','Yksityinen perhepäivähoito osa-aikainen 29h/viikko palse','Yksityinen perhepäivähoito osa-aikainen 29h/viikko palse', null,1, false, 1.0, 1.0),
    ('5c8bdebc-3350-11ed-a1e8-23631d9473d4','Yksityinen perhepäivähoito osapäivä 4h palse','Yksityinen perhepäivähoito osapäivä 4h palse','Private family daycare part time 4h service voucher',NULL,'DAYCARE_PART_TIME',FALSE,0.5,0.54,20,TRUE,FALSE,'Yksityinen perhepäivähoito osapäivä 4h palse','Yksityinen perhepäivähoito osapäivä 4h palse','Yksityinen perhepäivähoito osapäivä 4h palse','Yksityinen perhepäivähoito osapäivä 4h palse', null,1.75, false, 0.54, 1.75),

    -- PRESCHOOL
    ('de463c38-9f97-11ec-a22e-97907801ecdc','Esiopetus 4h ','Esiopetus 4h ','Pre-school education 4h ',NULL,'PRESCHOOL',TRUE,0,0.54,20,TRUE,FALSE,'Esiopetus 4h ','Esiopetus 4h ','Esiopetus 4h ','Esiopetus 4h', null,1.75, true, 0.54, 1.75),
    ('c288a152-9ef2-11ec-8540-2fc7b01eb49e','Esiopetus 4h ','Esiopetus 4h ','Pre-school education 4h ',NULL,'PRESCHOOL',FALSE,0,0.54,20,TRUE,FALSE,'Esiopetus 4h ','Esiopetus 4h ','Esiopetus 4h ','Esiopetus 4h', 2000,1.75, true, 0.54, 1.75),
    ('c288a26a-9ef2-11ec-8541-57b8edf0098f','Kaksivuotinen esiopetuskokeilu','Kaksivuotinen esiopetuskokeilu','A two-year pre-school trial',NULL,'PRESCHOOL',FALSE,0,0.54,20,TRUE,FALSE,'Kaksivuotinen esiopetuskokeilu','Kaksivuotinen esiopetuskokeilu','Kaksivuotinen esiopetuskokeilu','Kaksivuotinen esiopetuskokeilu', null,1.75, true, 0.54, 1.75),
    ('c288a2d8-9ef2-11ec-8542-231141d61e61','Yksityinen esiopetus 4 h palse','Yksityinen esiopetus 4 h palse','Private pre-school education 4 h service voucher',NULL,'PRESCHOOL',FALSE,0.0,0.54,20,TRUE,FALSE,'Yksityinen esiopetus 4 h palse','Yksityinen esioeptus 4 h palse','Yksityinen esioeptus 4 h palse','Yksityinen esioeptus 4 h palse', null,1.75, false, 0.54, 1.75),

    -- PRESCHOOL_DAYCARE
    ('de463c92-9f97-11ec-a22f-67d2f441c52f','Esiopetus + varhaiskasvatus','Esiopetus + varhaiskasvatus','Pre-school education + early childhood education',NULL,'PRESCHOOL_DAYCARE',TRUE,0.6,1.0,25,FALSE,FALSE,'Esiopetus + varhaiskasvatus','Esiopetus + varhaiskasvatus','Esiopetus + varhaiskasvatus','Esiopetus + varhaiskasvatus', null,1.75, true, 1.0, 1.75),
    ('c288a33c-9ef2-11ec-8543-c7f61d98bbff','Esiopetus + varhaiskasvatus','Esiopetus + varhaiskasvatus','Pre-school education + early childhood education',NULL,'PRESCHOOL_DAYCARE',FALSE,0.6,1.0,25,FALSE,FALSE,'Esiopetus + varhaiskasvatus','Esiopetus + varhaiskasvatus','Esiopetus + varhaiskasvatus','Esiopetus + varhaiskasvatus', null,1.75, true, 1.0, 1.75),
    ('2e0f93a8-e57b-11ec-a452-7f636f92b30c','Esiopetus + varhaiskasvatus 2v','Esiopetus + varhaiskasvatus 2v','Pre-school education + early childhood education 2y',NULL,'PRESCHOOL_DAYCARE',FALSE,0.6,1.0,25,FALSE,FALSE,'Esiopetus + varhaiskasvatus 2v','Esiopetus + varhaiskasvatus 2v','Esiopetus + varhaiskasvatus 2v','Esiopetus + varhaiskasvatus 2v', null,1.75, false, 1.0, 1.75),
    ('c288a3aa-9ef2-11ec-8544-072366604c6f','Esiopetus + varhaiskasvatus alle 3h','Esiopetus + varhaiskasvatus alle 3h','Pre-school education + early childhood education less than 3h',NULL,'PRESCHOOL_DAYCARE',FALSE,0.45,1.0,20,FALSE,FALSE,'Esiopetus + varhaiskasvatus alle 3h','Esiopetus + varhaiskasvatus alle 3h','Esiopetus + varhaiskasvatus alle 3h','Esiopetus + varhaiskasvatus alle 3h', null,1.75, true, 1.0, 1.75),
    ('c288a3fa-9ef2-11ec-8545-0feaf5efd1b9','Esiopetus + varhaiskasvatus 10 pv/kk','Esiopetus + varhaiskasvatus 10 pv/kk','Pre-school education + early childhood education 10 d/m',10,'PRESCHOOL_DAYCARE',FALSE,0.3,1.0,9.5,FALSE,FALSE,'Esiopetus + varhaiskasvatus 10 pv/kk','Esiopetus + varhaiskasvatus 10 pv/kk','Esiopetus + varhaiskasvatus 10 pv/kk','Esiopetus + varhaiskasvatus 10 pv/kk', null,1.75, true, 1.0, 1.75),
    ('c288a440-9ef2-11ec-8546-8f405f297780','Esiopetus + varhaiskasvatus 13 pv/kk','Esiopetus + varhaiskasvatus 13 pv/kk','Pre-school education + early childhood education 13 d/m',13,'PRESCHOOL_DAYCARE',FALSE,0.45,1.0,12.4,FALSE,FALSE,'Esiopetus + varhaiskasvatus 13 pv/kk','Esiopetus + varhaiskasvatus 13 pv/kk','Esiopetus + varhaiskasvatus 13 pv/kk','Esiopetus + varhaiskasvatus 13 pv/kk', null,1.75, true, 1.0, 1.75),
    ('91a50d60-3f28-11ed-8217-b35ad6248e8d','Esiopetus + varhaiskasvatus 10 pv/kk 2v','Esiopetus + varhaiskasvatus 10 pv/kk 2v','Pre-school education + early childhood education 10 d/m 2y',10,'PRESCHOOL_DAYCARE',FALSE,0.3,1.0,9.5,FALSE,FALSE,'Esiopetus + varhaiskasvatus 10 pv/kk 2v','Esiopetus + varhaiskasvatus 10 pv/kk 2v','Esiopetus + varhaiskasvatus 10 pv/kk 2v','Esiopetus + varhaiskasvatus 10 pv/kk 2v', null,1.75, false, 1.0, 1.75),
    ('bf4b4946-3f28-11ed-8218-0392ee6d4528','Esiopetus + varhaiskasvatus 13 pv/kk 2v','Esiopetus + varhaiskasvatus 13 pv/kk 2v','Pre-school education + early childhood education 13 d/m 2y',13,'PRESCHOOL_DAYCARE',FALSE,0.45,1.0,12.4,FALSE,FALSE,'Esiopetus + varhaiskasvatus 13 pv/kk 2v','Esiopetus + varhaiskasvatus 13 pv/kk 2v','Esiopetus + varhaiskasvatus 13 pv/kk 2v','Esiopetus + varhaiskasvatus 13 pv/kk 2v', null,1.75, false, 1.0, 1.75),
    ('99ab7baa-4083-11ed-8078-87d60cea9aea','Esiopetus + varhaiskasvatus alle 3h 2v','Esiopetus + varhaiskasvatus alle 3h 2v','Pre-school education + early childhood education less than 3h 2y',NULL,'PRESCHOOL_DAYCARE',FALSE,0.45,1.0,20,FALSE,FALSE,'Esiopetus + varhaiskasvatus alle 3h 2v','Esiopetus + varhaiskasvatus alle 3h 2v','Esiopetus + varhaiskasvatus alle 3h 2v','Esiopetus + varhaiskasvatus alle 3h 2v', null,1.75, false, 1.0, 1.75),
    ('c288a490-9ef2-11ec-8547-ab2d0b032c1c','Yksityinen esiopetus + varhaiskasvatus palse','Yksityinen esiopetus + varhaiskasvatus palse','Private pre-school education + early childhood education service voucher',NULL,'PRESCHOOL_DAYCARE',FALSE,0.6,1.0,25,FALSE,FALSE,'Yksityinen esiopetus + varhaiskasvatus palse','Yksityinen esiopetus + varhaiskasvatus palse','Yksityinen esiopetus + varhaiskasvatus palse','Yksityinen esiopetus + varhaiskasvatus palse', null,1.75, false, 1.0, 1.75),

    -- CLUB
    ('de463cec-9f97-11ec-a230-bb19e6bd6663','Kerho 2 x viikko','Kerho 2 x viikko','Club 2 x week',NULL,'CLUB',TRUE,0,1.0,10,FALSE,FALSE,'Kerho 2 x viikko','Kerho 2 x viikko','Kerho 2 x viikko','Kerho 2 x viikko', null,1.75, true, 1.0, 1.75),
    ('c288a4d6-9ef2-11ec-8548-53f49e3cb87b','Kerho 2 x viikko','Kerho 2 x viikko','Club 2 x week',NULL,'CLUB',FALSE,0,1.0,10,FALSE,FALSE,'Kerho 2 x viikko','Kerho 2 x viikko','Kerho 2 x viikko','Kerho 2 x viikko', null,1.75, true, 1.0, 1.75),
    ('c288a58a-9ef2-11ec-8549-2f93c47040bf','Kerho 3 x viikko','Kerho 3 x viikko','Club 3 x week',NULL,'CLUB',FALSE,0,1.0,10,FALSE,FALSE,'Kerho 3 x viikko','Kerho 3 x viikko','Kerho 3 x viikko','Kerho 3 x viikko', null,1.75, true, 1.0, 1.75),
    ('c288a5d0-9ef2-11ec-854a-b33b00871752','Perhekerho','Perhekerho','Family club',NULL,'CLUB',FALSE,0,1.0,10,FALSE,FALSE,'Perhekerho','Perhekerho','Perhekerho','Perhekerho', null,1.75, true, 1.0, 1.75),
    ('c288a620-9ef2-11ec-854b-13e81732636f','Tilapäinen kerho','Tilapäinen kerho','Temporary club',NULL,'CLUB',FALSE,0,1.0,10,FALSE,FALSE,'Tilapäinen kerho','Tilapäinen kerho','Tilapäinen kerho','Tilapäinen kerho', null,1.75, true, 1.0, 1.75),
    ('c288a666-9ef2-11ec-854c-8bcc8b9a9307','Yksityinen kerho palse','Yksityinen kerho palse','Private club service voucher',NULL,'CLUB',FALSE,1.0,1.0,10,FALSE,FALSE,'Yksityinen kerho palse','Yksityinen kerho palse','Yksityinen kerho palse','Yksityinen kerho palse', null,1.75, false, 1.0, 1.75),

    -- TEMPORARY_DAYCARE
    ('de463d32-9f97-11ec-a231-5bcd9b48daeb', 'Tilapäinen varhaiskasvatus','Tilapäinen varhaiskasvatus','Temporary early childhood education',NULL,'TEMPORARY_DAYCARE',TRUE,1.0,1.0,40,FALSE,FALSE,'Tilapäinen varhaiskasvatus','Tilapäinen varhaiskasvatus','Tilapäinen varhaiskasvatus','Tilapäinen varhaiskasvatus', null,1.75, true, 1.0, 1.75),
    ('c288a6ac-9ef2-11ec-854d-8ba46873165a','Tilapäinen varhaiskasvatus','Tilapäinen varhaiskasvatus','Temporary early childhood education',NULL,'TEMPORARY_DAYCARE',FALSE,1.0,1.0,40,FALSE,FALSE,'Tilapäinen varhaiskasvatus','Tilapäinen varhaiskasvatus','Tilapäinen varhaiskasvatus','Tilapäinen varhaiskasvatus', null,1.75, true, 1.0, 1.75),

    -- TEMPORARY_DAYCARE_PART_DAY
    ('7dedd9a8-a04c-11ec-a72b-3779d97aac97','Tilapäinen osa-aikainen varhaiskasvatus','Tilapäinen osa-aikainen varhaiskasvatus','temporary part-time early childhood education',NULL,'TEMPORARY_DAYCARE_PART_DAY',TRUE,1.0,0.54,20,TRUE,FALSE,'Tilapäinen osa-aikainen varhaiskasvatus','Tilapäinen osa-aikainen varhaiskasvatus','Tilapäinen osa-aikainen varhaiskasvatus','Tilapäinen osa-aikainen varhaiskasvatus', null,1.75, true, 0.54, 1.75),
    ('c288a706-9ef2-11ec-854e-8fec0360d917','Tilapäinen osa-aikainen varhaiskasvatus','Tilapäinen osa-aikainen varhaiskasvatus','temporary part-time early childhood education',NULL,'TEMPORARY_DAYCARE_PART_DAY',FALSE,1.0,0.54,20,TRUE,FALSE,'Tilapäinen osa-aikainen varhaiskasvatus','Tilapäinen osa-aikainen varhaiskasvatus','Tilapäinen osa-aikainen varhaiskasvatus','Tilapäinen osa-aikainen varhaiskasvatus', null,1.75, true, 0.54, 1.75),

    -- PREPARATORY
    ('de463d82-9f97-11ec-a232-a782189e7c84', 'Valmistava esiopetus','Valmistava esiopetus','Preparatory pre-school education',NULL,'PREPARATORY',TRUE,0,0.54,25,TRUE,FALSE,'Valmistava esiopetus','Valmistava esiopetus','Valmistava esiopetus','Valmistava esiopetus', null,1.75, true, 0.54, 1.75),
    ('c288a74c-9ef2-11ec-854f-935955a88b27','Valmistava esiopetus','Valmistava esiopetus','Preparatory pre-school education',NULL,'PREPARATORY',FALSE,0,0.54,25,TRUE,FALSE,'Valmistava esiopetus','Valmistava esiopetus','Valmistava esiopetus','Valmistava esiopetus', null,1.75, true, 0.54, 1.75),

    -- PREPARATORY_DAYCARE
    ('05999cd6-1fa3-11ed-b545-8f2c5e506764','Valmistava esiopetus + varhaiskasvatus','Valmistava esiopetus + varhaiskasvatus','Preparatory pre-school education + early childhood education',NULL,'PREPARATORY_DAYCARE',TRUE,0.6,1.0,25,TRUE,FALSE,'Valmistava esiopetus + varhaiskasvatus','Valmistava esiopetus + varhaiskasvatus','Valmistava esiopetus + varhaiskasvatus','Valmistava esiopetus + varhaiskasvatus', null,1.75, true, 1.0, 1.75),
...
WHERE
    ...
    service_need_option.realized_occupancy_coefficient_under_3y <> EXCLUDED.realized_occupancy_coefficient_under_3y;
...
VALUES
    ...
    ('cfee4b18-0b74-11ee-a6f7-83902e0d7eca','c288a2d8-9ef2-11ec-8542-231141d61e61',daterange('2023-08-01', NULL, '[]'),92500,0.5,46300,157200,1.0,157200),
    ...
    ('cfee58ec-0b74-11ee-a6f8-3fce620497c8','c288a490-9ef2-11ec-8547-ab2d0b032c1c',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,0.5,78600),
    ...
    ('4e878b8e-0c05-11ee-9a96-03d93a4f0ec0','c2886fca-9ef2-11ec-8539-1b9652921b6d',daterange('2023-08-01', NULL, '[]'),92500,0.7,64700,157200,0.7,110000),
    ...
    ('cfee59e6-0b74-11ee-a6f9-c35bf414c612','c2889e1e-9ef2-11ec-853a-aff6768857cb',daterange('2023-08-01', NULL, '[]'),92500,0.7,64700,157200,0.7,110000),
    ...
    ('cfee61a2-0b74-11ee-a6fa-43eb9209153f','c2889f72-9ef2-11ec-853c-3bc6a35d44a3',daterange('2023-08-01', NULL, '[]'),92500,0.55,50900,157200,0.55,86500),
    ...
    ('cfee6b20-0b74-11ee-a6fb-cf1501ae7f34','50359334-b961-11eb-b525-f3febdfea5d3',daterange('2023-08-01', NULL , '[]'),92500,0.55,50900,157200,0.55,86500),
    ...
    ('cfee6c24-0b74-11ee-a6fc-07969750bf3b','d146f678-130d-11ed-a574-c39e98171347',daterange('2023-08-01', NULL, '[]'),87400,0.7,61200,87400,0.7,61200),
    ...
    ('cfee6cc4-0b74-11ee-a6fd-675e1236f4a7','07a1bde8-130e-11ed-a575-bbe09459e8d0',daterange('2023-08-01', NULL, '[]'),87400,0.7,61200,87400,0.7,61200),
    ...
    ('cfee6d50-0b74-11ee-a6fe-af9ca909f518','5c8bdebc-3350-11ed-a1e8-23631d9473d4',daterange('2023-08-01', NULL, '[]'),87400,0.55,48100,87400,0.55,48100),
    ...
    ('cfee6dd2-0b74-11ee-a6ff-73ffb421c653','86495b70-130d-11ed-a573-bfda992853b8',daterange('2023-08-01', NULL, '[]'),87400,0.55,48100,87400,0.55,48100),
    ...
    ('cfee6e5e-0b74-11ee-a700-0316ebba7e86','c288a0c6-9ef2-11ec-853f-47b02ebd51bb',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ...
    ('cfee6ee0-0b74-11ee-a701-7f7cb3818863','19094188-130d-11ed-a572-473907d23b65',daterange('2023-08-01', NULL, '[]'),87400,1.0,87400,87400,1.0,87400),
    ...
    -- 2023-08-01 -
    ('cfee6f6c-0b74-11ee-a702-b39551de1022','de463972-9f97-11ec-a22c-931f5a294cea',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee6fee-0b74-11ee-a703-cbe81f26ce46','86ef70a0-bf85-11eb-91e6-1fb57a101161',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee7070-0b74-11ee-a704-df1d871aca52','503590f0-b961-11eb-b520-53740af3f7ee',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee70fc-0b74-11ee-a705-f33a207bfb0f','503591ae-b961-11eb-b521-1fca99358eef',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee717e-0b74-11ee-a706-e336e1e17fa1','c288a058-9ef2-11ec-853e-9bcaa26ea729',daterange('2023-08-01', NULL, '[]'),92500,0.0,0,157200,0.0,0),
    ('cfee7200-0b74-11ee-a707-27d5d5320fdf','de463bd4-9f97-11ec-a22d-4791bc036bd9',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee7296-0b74-11ee-a708-ef8e4504a621','86ef7370-bf85-11eb-91e7-6fcd728c518d',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee7322-0b74-11ee-a709-7f7205aee2d3','c2886f84-9ef2-11ec-8538-734ab2ac6c71',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee73a4-0b74-11ee-a70a-d3c6b52c7e11','c2889ef0-9ef2-11ec-853b-2f545a699ef0',daterange('2023-08-01', NULL, '[]'),92500,0.0,0,157200,0.0,0),
    ('cfee7430-0b74-11ee-a70b-ff6fed9e4f2d','de463c38-9f97-11ec-a22e-97907801ecdc',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee74b2-0b74-11ee-a70c-db68cf1ff61a','c288a152-9ef2-11ec-8540-2fc7b01eb49e',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee7534-0b74-11ee-a70d-73ee94c8f1b1','c288a26a-9ef2-11ec-8541-57b8edf0098f',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee75e8-0b74-11ee-a70e-4b00dfa3329f','de463c92-9f97-11ec-a22f-67d2f441c52f',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee766a-0b74-11ee-a70f-bfc9a194f4c0','c288a33c-9ef2-11ec-8543-c7f61d98bbff',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee76f6-0b74-11ee-a710-37a615dcdf15','2e0f93a8-e57b-11ec-a452-7f636f92b30c',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfee7b38-0b74-11ee-a711-47cc206e2a32','c288a3aa-9ef2-11ec-8544-072366604c6f',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeeaa86-0b74-11ee-a712-f76fb6159077','c288a3fa-9ef2-11ec-8545-0feaf5efd1b9',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeeaf36-0b74-11ee-a713-379b057d01aa','c288a440-9ef2-11ec-8546-8f405f297780',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeeb012-0b74-11ee-a714-2fb4cf76be27','adff4b3e-4607-11ed-b4df-b338fa9c8022',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeeb0bc-0b74-11ee-a715-7f956c010bf0','274acbd0-4608-11ed-b4e0-07ecacd56b03',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeeb184-0b74-11ee-a716-638139969c53','4e62e91e-4608-11ed-b4e1-ab7b3db89639',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeeb210-0b74-11ee-a717-9f5e94aa9234','91a50d60-3f28-11ed-8217-b35ad6248e8d',daterange('2023-08-01', NULL, '[]'),92500,0.55,50900,157200,0.55,86500),
    ('cfeeb2ce-0b74-11ee-a718-ab6ceb80feea','bf4b4946-3f28-11ed-8218-0392ee6d4528',daterange('2023-08-01', NULL, '[]'),92500,0.7,64700,157200,0.7,110000),
    ('cfeeb364-0b74-11ee-a719-abdbc9c01a1d','99ab7baa-4083-11ed-8078-87d60cea9aea',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeeb3f0-0b74-11ee-a71a-d742563e27ee','de463cec-9f97-11ec-a230-bb19e6bd6663',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeeb472-0b74-11ee-a71b-0747fc00bd31','c288a4d6-9ef2-11ec-8548-53f49e3cb87b',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeeb4f4-0b74-11ee-a71c-570c93fae723','c288a58a-9ef2-11ec-8549-2f93c47040bf',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeeb576-0b74-11ee-a71d-ab986eafc5ac','c288a5d0-9ef2-11ec-854a-b33b00871752',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeec8d6-0b74-11ee-a71e-b7f6f1605d51','c288a620-9ef2-11ec-854b-13e81732636f',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeec994-0b74-11ee-a71f-0be02f23126e','c288a666-9ef2-11ec-854c-8bcc8b9a9307',daterange('2023-08-01', NULL, '[]'),19800,1.0,19800,19800,1.0,19800),
    ('cfeeca20-0b74-11ee-a720-17dfbca50248','de463d32-9f97-11ec-a231-5bcd9b48daeb',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeecaac-0b74-11ee-a721-0318cdb0acb7','c288a6ac-9ef2-11ec-854d-8ba46873165a',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeecb2e-0b74-11ee-a722-0b0ef52cc041','7dedd9a8-a04c-11ec-a72b-3779d97aac97',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeecbba-0b74-11ee-a723-bf76cdcf1b3f','c288a706-9ef2-11ec-854e-8fec0360d917',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeed0ec-0b74-11ee-a724-375af2d57666','de463d82-9f97-11ec-a232-a782189e7c84',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
    ('cfeed178-0b74-11ee-a725-330014090f7e','c288a74c-9ef2-11ec-854f-935955a88b27',daterange('2023-08-01', NULL, '[]'),92500,1.0,92500,157200,1.0,157200),
