...
import fi.oulu.evakaoulu.EVakaOuluProperties
import fi.oulu.evakaoulu.InvoiceProperties
import fi.oulu.evakaoulu.IpaasProperties
import fi.oulu.evakaoulu.invoice.config.InvoiceConfiguration
...
internal class EVakaOuluInvoiceClientTest {
    ...
    @BeforeEach
    fun setup() {
        val properties = EVakaOuluProperties(
